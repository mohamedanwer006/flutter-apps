                ...
                child: Padding(
                  ...
                  child: Container(
                      decoration: BoxDecoration(
                        borderRadius:
                            BorderRadius.circular(screenWidth(context, 25)),
        ...
        child: Column(
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(hintText: 'Wi_Fi Password'),
              validator: (val) {
                if (val.isEmpty) {
  ...
  sendData()async {
    ...
    if (formState.validate()) {
      ...
      try {
        ...
        showLoading();
        var res = await _apModeServices.sendData(_ssidController.text, _passController.text);
        if(res!=null){
          if(res){
           Navigator.pushReplacementNamed(context, HomeApp.route); 
          }else{
            showError();
          }
        }
