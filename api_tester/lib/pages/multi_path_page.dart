...
class MultiPathPage extends StatefulWidget {
  static const String routeName = '/multiPathPage';
  const MultiPathPage({Key? key}) : super(key: key);

  @override
  _MultiPathPageState createState() => _MultiPathPageState();
}

class _MultiPathPageState extends State<MultiPathPage> {
  ApiRepo apiRepo = ApiRepo();
  final TextEditingController _baseUrlEditingControler =
      TextEditingController(text: 'https://jsonplaceholder.typicode.com/');
        ...
        children: [
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              width: width,
              child: TextField(
                controller: _baseUrlEditingControler,
                decoration: const InputDecoration(
                    alignLabelWithHint: true,
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10)),
  ...
  run() async {
    ...
    var serviceEndpint = ServiceEndpoint(
        serviceUrl: _baseUrlEditingControler.text, requestType: requestMethode);
