import 'package:test_image_edite/models/basic.dart';
import 'package:test_image_edite/models/image_data.dart';
import 'package:test_image_edite/screens/show_screen.dart';
import 'package:test_image_edite/widgets/smiley_add_widget.dart';
import 'package:test_image_edite/widgets/story_create_widget.dart';
import 'package:test_image_edite/widgets/text_add_widget.dart';
                          ...
                          if (controller != null) {
                            ...
                            controller.createStory().then((val) {
                              ...
                              if (val!=null) {
                                ...
                                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>Show(val)));
//                                Navigator.of(context).pop();
                              }
                              else{
